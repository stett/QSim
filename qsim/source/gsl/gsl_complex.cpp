...
{                               /* z = arcsin(a) */
  ...
  if (fabs (a) <= 1.0)
  ...
  else
    {
      if (a < 0.0)
        {
          GSL_SET_COMPLEX (&z, -M_PI_2, gsl_acosh (-a));
        }
      else
        {
          GSL_SET_COMPLEX (&z, M_PI_2, -gsl_acosh (a));
...
{                               /* z = arccos(a) */
  ...
  if (fabs (a) <= 1.0)
  ...
  else
    {
      if (a < 0.0)
        {
          GSL_SET_COMPLEX (&z, M_PI, -gsl_acosh (-a));
        }
      else
        {
          GSL_SET_COMPLEX (&z, 0, gsl_acosh (a));
        }
    }
...
{                               /* z = arcsec(a) */
  ...
  if (a <= -1.0 || a >= 1.0)
  ...
  else
    {
      if (a >= 0.0)
        {
          GSL_SET_COMPLEX (&z, 0, gsl_acosh (1 / a));
        }
      else
        {
          GSL_SET_COMPLEX (&z, M_PI, -gsl_acosh (-1 / a));
        }
    }
...
{                               /* z = arccsc(a) */
  ...
  if (a <= -1.0 || a >= 1.0)
  ...
  else
    {
      if (a >= 0.0)
        {
          GSL_SET_COMPLEX (&z, M_PI_2, -gsl_acosh (1 / a));
        }
      else
        {
          GSL_SET_COMPLEX (&z, -M_PI_2, gsl_acosh (-1 / a));
...
{                               /* z = arccosh(a) */
  ...
  if (a >= 1)
    {
      GSL_SET_COMPLEX (&z, gsl_acosh (a), 0);
    }
  else
    {
      if (a >= -1.0)
        ...
        {
          GSL_SET_COMPLEX (&z, gsl_acosh (-a), M_PI);
        }
    }
...
{                               /* z = arctanh(a) */
  ...
  if (a > -1.0 && a < 1.0)
    {
      GSL_SET_COMPLEX (&z, gsl_atanh (a), 0);
    }
  else
    {
      GSL_SET_COMPLEX (&z, gsl_atanh (1 / a), (a < 0) ? M_PI_2 : -M_PI_2);
    }
